      ...
      <Disclosure.Panel className="sm:hidden">
        {currentUser ? (
          <div className="absolute right-0 z-50 origin-top-right rounded-md bg-color7-light py-1 shadow-lg ring-1 ring-color6-lightgrey focus:outline-none">
            <span
              className="block px-4 py-2 text-sm text-color5-dark hover:bg-color6-lightgrey cursor-alias"
          ...
          <div className="absolute right-0 z-50 origin-top-right rounded-md bg-color7-light py-1 shadow-lg ring-1 ring-color6-lightgrey focus:outline-none">
            {/* <SwitchButton className="block px-4 py-2 text-sm text-color5-dark hover:bg-color6-lightgrey" /> */}
            <span
